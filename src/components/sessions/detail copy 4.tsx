       ...
       <Accordion.Item value="numplace">
        ...
        <Accordion.Item value="photocapture">
                ...
                <Accordion.Item value="PaperEvReport">
                                ...
                                props.data.task.data.map((item:any, index:number)=>{
                                    return(
                                        ...
                                        {      (item.name.split("-")[0] === "PaperEv") && ( 
                                            ...
                                            <div> 
                                                <td style={{ width:"80%", textAlign:"left" }}> 
                                            { item.name === "PaperEv-Report" && (<div>1. Paper evidence report from witnesses.</div>)} 
                        ...
                        <Accordion.Item value="PhotoEvPlaster">
                                        ...
                                        props.data.task.data.map((item:any, index:number)=>{
                                            return(
                                                ...
                                                {      (item.name.split("-")[0] === "PhotoEv") && ( 
                                                    ...
                                                    { item.name === "PhotoEv-Soil" && (<div>Picture of the soil sample</div>)} 
                                                    { item.name === "PhotoEv-Overview" && (<div>Overview Shot</div>)} 
                                                    { item.name === "PhotoEv-Mid" && (<div>Mid-Range Shot</div>)} 
                                                    { item.name === "PhotoEv-Close" && (<div>Close-Up Shot</div>)} 
