                                                                    ...
                                                                    props.data.task.data.map((item:any, index:number)=>{
                                                                        return(
                                                                            ...
                                                                            <tr key={`${index}name`} className="text-center">
                                                                                <td>
                                                                                    {  item.name == "PPE-Shoes" && <div style={{ width:"400px", textAlign:"left",display: "flex"  }}>1. Safety Shoes </div> }
                                                                                    {  item.name == "PPE-Cover" && <div style={{ width:"400px", textAlign:"left",display: "flex"  }}>2. Coverall / Jacket    </div>}
                                                                                    {  item.name == "PPE-Helmet" && <div style={{ width:"400px", textAlign:"left",display: "flex"  }}>3. Safety helmet    </div>}
                                                                                    {  item.name == "PPE-Gloves" && <div style={{ width:"400px", textAlign:"left",display: "flex"  }}>4. Hand gloves   </div>}
                                                                                    {  item.name == "PPE-Harness" && <div style={{ width:"400px", textAlign:"left",display: "flex"  }}>5. Safety harness    </div>}
                                                                                ...
                                                                                <td className="text-right" style={{ width:"100%", textAlign:"right",display: "flex"  }}>
                                                                                    ...
                                                                                    item.status == "Completed" && <div ><Chip size="sm"  color="success"><Chip.Label >Completed</Chip.Label></Chip></div>
