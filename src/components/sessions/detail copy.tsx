                                            ...
                                            props.data.task.data.map((item:any, index:number)=>{
                                                return(
                                                    <tr key={`${index}name`} className="text-center">
                                                        <td>
                                                            {  item.name == "PPE-1" && <div style={{ width:"400px", textAlign:"left",display: "flex"  }}>1. Safety Shoes </div>}
                                                            {  item.name == "PPE-2" && <div style={{ width:"400px", textAlign:"left",display: "flex"  }}>2. Coverall / Jacket    </div>}
                                                        </td>
